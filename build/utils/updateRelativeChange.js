    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                totalNetWorth = stocks.netWorthHistory[stocks.netWorthHistory.length - 1].netWorth;
                previousNetWorth = stocks.netWorthHistory[stocks.netWorthHistory.length - 2].netWorth;
                relativeChange = stocks.relativeChangeHistory[stocks.relativeChangeHistory.length - 1].relativeChange * (totalNetWorth / previousNetWorth);
            ...
            case 2:
                ...
                response = "updating relative change for user " + username;
                return [2 /*return*/, response];
        }
    });
}); };
exports.updateRelativeChange = updateRelativeChange;
