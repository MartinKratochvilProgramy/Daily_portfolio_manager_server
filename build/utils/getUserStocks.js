    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                foundStocks = _a.sent();
                if (foundStocks) {
                    stocks = foundStocks.stocks;
                    purchaseHistory = foundStocks.purchaseHistory;
                    result = [];
                    _loop_1 = function (i) {
                        // construct array of stock objects {ticker, amount, prevClose, _id, firstPurchase, lastPurchase}
                        var ticker = stocks[i].ticker;
                        var index = purchaseHistory.findIndex(function (stock) { return stock.ticker === ticker; }); // index of ticker in purchaseHistory
                        var stockObject = {
